...
class SourceHistory{
  ...
  static Future<bool> add(String idUser, String date, String type,String details,String total) async {
    ...
    if(responseBody['success']){
      ...
      if(responseBody['message'] == 'date'){
        DInfo.dialogError('History dengan tanggal tersebut sudah pernah terdaftar!');
      }else{
  ...
  static Future<bool> update(String idHistory, String idUser, String date, String type,String details,String total) async {
    ...
    if(responseBody['success']){
      ...
      if(responseBody['message'] == 'date'){
        DInfo.dialogError('Tanggal History Bertabrakan!');
      }else{
        DInfo.dialogError('Gagal Tambah History');
      }
      DInfo.closeDialog();
  ...
  static Future<History?> detai(String idUser, String date, String type) async {
